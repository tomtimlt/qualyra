<x-app-layout>
    ...
    <div class="form-page">
        ...
        <form method="POST" action="{{ route('organization.store') }}" class="form-card">
            @csrf
            ...
            <div class="form-grid">
                <div>
                    ...
                    <x-text-input id="name" name="name" type="text" required autofocus
                                  :value="old('name')" style="margin-top: 6px" />
                ...
                <div>
                    ...
                    <x-text-input id="siret" name="siret" type="text" maxlength="14"
                                  :value="old('siret')" placeholder="14 chiffres"
                                  style="margin-top: 6px; font-family: var(--font-mono)" />
                    <p class="help">Apparaîtra en couverture du rapport. Aucune vérification automatique.</p>
            ...
            <div class="form-grid">
                <div>
                    <x-input-label for="size" value="Taille *" />
                ...
                <div>
                    ...
                    <x-text-input id="sector" name="sector" type="text"
                                  :value="old('sector')" placeholder="Ex : Industrie, Santé, RH"
            ...
            <div class="form-actions">
                <a href="{{ route('dashboard') }}" class="btn-link">← Annuler</a>
